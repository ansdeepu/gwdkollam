...
export const userRoleOptions = ['editor', 'viewer', 'supervisor'] as const;
...
export const SiteDetailSchema = z.object({
  ...
  innerCasingPipe: z.string().optional(),
  ...
  pumpingLineLength: z.string().optional().nullable().default(""),
  deliveryLineLength: z.string().optional().nullable().default(""),
  ...
  surveyLocation: z.string().optional(),
  surveyPlainPipe: z.string().optional(),
  surveySlottedPipe: z.string().optional(),

  // Survey Details (Recommended)
  surveyRemarks: z.string().optional(),
  surveyRecommendedDiameter: z.string().optional(),
  surveyRecommendedTD: z.string().optional(),
  surveyRecommendedOB: z.string().optional(),
  surveyRecommendedCasingPipe: z.string().optional(),
