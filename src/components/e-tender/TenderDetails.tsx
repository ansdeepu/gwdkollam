                            ...
                            <AccordionItem value="basic-details" className="border rounded-lg">
                                ...
                                <AccordionContent className="p-6 pt-0">
                                    <dl className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-4 gap-y-3 pt-4 border-t">
                                        ...
                                        <div className="lg:col-span-3"><DetailRow label="Name of Work" value={form.watch('nameOfWork')} /></div>
                                        <div className="lg:col-span-3"><DetailRow label="Name of Work (Malayalam)" value={form.watch('nameOfWorkMalayalam')} /></div>
                                        ...
                                        <DetailRow label="Last Date & Time of Receipt" value={`${formatDateSafe(form.watch('lastDateOfReceipt'))} ${form.watch('timeOfReceipt')}`} />
                                        <DetailRow label="Date & Time of Opening" value={`${formatDateSafe(form.watch('dateOfOpeningTender'))} ${form.watch('timeOfOpeningTender')}`} />
                                    </dl>
                                </AccordionContent>
                            </AccordionItem>
