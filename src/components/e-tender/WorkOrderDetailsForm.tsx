...
export default function WorkOrderDetailsForm({ form, onSubmit, onCancel, isSubmitting }: WorkOrderDetailsFormProps) {
    ...
    return (
        <>
            <DialogHeader className="p-6 pb-4">
                ...
                <DialogDescription>Enter details related to the final work order.</DialogDescription>
            </DialogHeader>
