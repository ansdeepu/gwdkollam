                                ...
                                <div className="grid md:grid-cols-3 gap-6">
                                        ...
                                        <FormField control={form.control} name={`siteDetails.${index}.accessibleRig`} render={({ field }) => (
                                            <FormItem>
                                                ...
                                                <Select onValueChange={(value) => field.onChange(value === '_clear_' ? undefined : value)} value={field.value} disabled={!isEditor}>
                                                    ...
                                                    <SelectContent>
                                                        <SelectItem value="_clear_" onSelect={(e) => e.preventDefault()}>-- Clear Selection --</SelectItem>
                                    ...
                                    <FormField
                                        ...
                                        {isEditor ? (
                                            ...
                                            <SelectContent>
                                                <SelectItem value="_unassign_" onSelect={(e) => e.preventDefault()}>-- Unassign Supervisor --</SelectItem>
