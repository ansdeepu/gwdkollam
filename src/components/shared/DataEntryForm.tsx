...
const SUPERVISOR_WORK_STATUS_OPTIONS: SiteWorkStatus[] = ["Work Order Issued", "Work in Progress", "Work Failed", "Work Completed", "Awaiting Dept. Rig"];
                ...
                <AccordionContent className="p-6 pt-0">
                    <div className="border-t pt-6 space-y-4">
                        <Accordion type="multiple" className="w-full space-y-2">
                            ...
                            const supervisorCannotEdit = isSupervisor && (!isAssignedToCurrentUser || isSitePendingForSupervisor);
                            const siteIsEditable = isEditor || (isSupervisor && !supervisorCannotEdit);
                            const isSiteCompletelyReadOnly = isViewer || supervisorCannotEdit;
                            ...
                            const workImplementationFields = (
                              <>
                                ...
                                <div className="grid md:grid-cols-3 gap-6">
                                    {isRigAccessibilityRequired && (
                                        <FormField control={form.control} name={`siteDetails.${index}.accessibleRig`} render={({ field }) => (
                                            <FormItem>
                                                ...
                                                <Select onValueChange={(value) => field.onChange(value === '_clear_' ? undefined : value)} value={field.value ?? undefined} disabled={isSiteCompletelyReadOnly || !isEditor}>
                                    ...
                                    <FormField control={form.control} name={`siteDetails.${index}.estimateAmount`} render={({ field }) => (<FormItem><FormLabel>Estimate (₹)</FormLabel><FormControl><Input type="text" inputMode="numeric" {...field} value={field.value ?? ""} readOnly={isSiteCompletelyReadOnly || !isEditor} /></FormControl><FormMessage/></FormItem>)}/>
                                    <FormField control={form.control} name={`siteDetails.${index}.remittedAmount`} render={({ field }) => (<FormItem><FormLabel>Remitted Amount (₹)</FormLabel><FormControl><Input type="text" inputMode="numeric" {...field} value={field.value ?? ""} readOnly={isSiteCompletelyReadOnly || !isEditor} /></FormControl><FormMessage/></FormItem>)}/>
                                    <FormField control={form.control} name={`siteDetails.${index}.tsAmount`} render={({ field }) => (<FormItem><FormLabel>TS Amount (₹)</FormLabel><FormControl><Input type="text" inputMode="numeric" {...field} value={field.value ?? ""} readOnly={isSiteCompletelyReadOnly || !isEditor} /></FormControl><FormMessage/></FormItem>)}/>
                                    {!isPrivateApplication && (
                                      <>
                                        <FormField control={form.control} name={`siteDetails.${index}.tenderNo`} render={({ field }) => (<FormItem><FormLabel>Tender No.</FormLabel><FormControl><Input {...field} value={field.value ?? ""} readOnly={isSiteCompletelyReadOnly || !isEditor} /></FormControl><FormMessage/></FormItem>)}/>
                                        <FormField control={form.control} name={`siteDetails.${index}.contractorName`} render={({ field }) => (<FormItem><FormLabel>Contractor Name</FormLabel><FormControl><Input {...field} value={field.value ?? ""} readOnly={isSiteCompletelyReadOnly || !isEditor} /></FormControl><FormMessage/></FormItem>)}/>
                                      </>
                                    )}
                                    <FormField
                                        key={item.id}
                                        ...
                                        {isEditor ? (
                                            <Select
                                            disabled={isSiteCompletelyReadOnly || !isEditor}
                                            onValueChange={(value) => {
                                                if (value === '_unassign_') {
                                                field.onChange(null);
                                                formSetValue(`siteDetails.${index}.supervisorName`, null);
                            ...
                            if (isSupervisor && !isAssignedToCurrentUser && fileNoToEdit) {
                            ...
                            return (
                                <AccordionItem value={`site-${index}`} key={item.id} className="border bg-card rounded-lg shadow-sm">
                                    ...
                                    <AccordionContent className="p-6 pt-0">
                                        ...
                                        <div className="border-t pt-6 space-y-6">
                                            <div className="grid md:grid-cols-3 gap-6">
                                                <FormField control={form.control} name={`siteDetails.${index}.nameOfSite`} render={({ field }) => (<FormItem><FormLabel>Name of Site <span className="text-destructive">*</span></FormLabel><FormControl><Input {...field} value={field.value ?? ""} readOnly={isSiteCompletelyReadOnly || !isEditor} /></FormControl><FormMessage/></FormItem>)}/>
                                                <FormField control={form.control} name={`siteDetails.${index}.purpose`} render={({ field }) => (<FormItem><FormLabel>Purpose <span className="text-destructive">*</span></FormLabel><Select onValueChange={field.onChange} value={field.value ?? undefined} disabled={isSiteCompletelyReadOnly || !isEditor}><FormControl><SelectTrigger><SelectValue placeholder="Select Purpose"/></SelectTrigger></FormControl><SelectContent>{sitePurposeOptions.map(o=><SelectItem key={o} value={o}>{o}</SelectItem>)}</SelectContent></Select><FormMessage/></FormItem>)}/>
                                                <FormField name={`siteDetails.${index}.constituency`} control={form.control} render={({ field }) => ( <FormItem><FormLabel>Constituency (LAC)</FormLabel><Select onValueChange={field.onChange} value={field.value ?? undefined} disabled={isSiteCompletelyReadOnly || !isEditor}><FormControl><SelectTrigger><SelectValue placeholder="Select Constituency" /></SelectTrigger></FormControl><SelectContent>{[...constituencyOptions].sort((a, b) => a.localeCompare(b)).map(o => <SelectItem key={o} value={o}>{o}</SelectItem>)}</SelectContent></Select><FormMessage /></FormItem> )}/>
                                            </div>
                                            <div className="grid md:grid-cols-2 gap-6">
                                                <FormField control={form.control} name={`siteDetails.${index}.latitude`} render={({ field }) => (<FormItem><FormLabel>Latitude</FormLabel><FormControl><Input type="text" inputMode="numeric" {...field} value={field.value ?? ""} readOnly={isSiteCompletelyReadOnly || !isEditor} /></FormControl><FormMessage/></FormItem>)}/>
                                                <FormField control={form.control} name={`siteDetails.${index}.longitude`} render={({ field }) => (<FormItem><FormLabel>Longitude</FormLabel><FormControl><Input type="text" inputMode="numeric" {...field} value={field.value ?? ""} readOnly={isSiteCompletelyReadOnly || !isEditor} /></FormControl><FormMessage/></FormItem>)}/>
                                            </div>
                                            ...
                                            {isWellPurpose && (
                                                <>
                                                    ...
                                                    {purpose === 'BWC' && ( <div className="grid md:grid-cols-3 gap-6"> <FormField control={form.control} name={`siteDetails.${index}.diameter`} render={({ field }) => (<FormItem><FormLabel>Diameter (mm){isDiameterRequired && <span className="text-destructive">*</span>}</FormLabel><Select onValueChange={(value) => field.onChange(value === '_clear_' ? undefined : value)} value={field.value ?? undefined} disabled={isSiteCompletelyReadOnly || !isEditor}><FormControl><SelectTrigger><SelectValue placeholder="Select Diameter"/></SelectTrigger></FormControl><SelectContent><SelectItem value="_clear_" onSelect={(e) => { e.preventDefault(); field.onChange(undefined); }}>-- Clear Selection --</SelectItem>{siteDiameterOptions.map(o=><SelectItem key={o} value={o}>{o}</SelectItem>)}</SelectContent></Select><FormMessage/></FormItem>)}/> <FormField control={form.control} name={`siteDetails.${index}.totalDepth`} render={({ field }) => (<FormItem><FormLabel>TD (m)</FormLabel><FormControl><Input type="text" inputMode="numeric" {...field} value={field.value ?? ""} readOnly={isSiteCompletelyReadOnly || !isEditor} /></FormControl><FormMessage/></FormItem>)}/> <FormField control={form.control} name={`siteDetails.${index}.surveyOB`} render={({ field }) => (<FormItem><FormLabel>OB (m)</FormLabel><FormControl><Input type="text" inputMode="numeric" {...field} value={field.value ?? ""} readOnly={isSiteCompletelyReadOnly || !isEditor} /></FormControl><FormMessage/></FormItem>)}/> <FormField control={form.control} name={`siteDetails.${index}.casingPipeUsed`} render={({ field }) => (<FormItem><FormLabel>Casing Pipe (m)</FormLabel><FormControl><Input {...field} value={field.value ?? ""} readOnly={isSiteCompletelyReadOnly || !isEditor} /></FormControl><FormMessage/></FormItem>)}/> <FormField control={form.control} name={`siteDetails.${index}.innerCasingPipe`} render={({ field }) => (<FormItem><FormLabel>Inner Casing (m)</FormLabel><FormControl><Input {...field} value={field.value ?? ""} readOnly={isSiteCompletelyReadOnly || !isEditor} /></FormControl><FormMessage/></FormItem>)}/> <FormField control={form.control} name={`siteDetails.${index}.outerCasingPipe`} render={({ field }) => (<FormItem><FormLabel>Outer Casing (m)</FormLabel><FormControl><Input {...field} value={field.value ?? ""} readOnly={isSiteCompletelyReadOnly || !isEditor} /></FormControl><FormMessage/></FormItem>)}/> <FormField control={form.control} name={`siteDetails.${index}.yieldDischarge`} render={({ field }) => (<FormItem><FormLabel>Discharge (LPH)</FormLabel><FormControl><Input {...field} value={field.value ?? ""} readOnly={isSiteCompletelyReadOnly || !isEditor} /></FormControl><FormMessage/></FormItem>)}/> <FormField control={form.control} name={`siteDetails.${index}.zoneDetails`} render={({ field }) => (<FormItem><FormLabel>Zone Details (m)</FormLabel><FormControl><Input {...field} value={field.value ?? ""} readOnly={isSiteCompletelyReadOnly || !isEditor} /></FormControl><FormMessage/></FormItem>)}/> <FormField control={form.control} name={`siteDetails.${index}.waterLevel`} render={({ field }) => (<FormItem><FormLabel>Water Level (m)</FormLabel><FormControl><Input {...field} value={field.value ?? ""} readOnly={isSiteCompletelyReadOnly || !isEditor} /></FormControl><FormMessage/></FormItem>)}/> <FormField control={form.control} name={`siteDetails.${index}.typeOfRig`} render={({ field }) => (<FormItem><FormLabel>Type of Rig</FormLabel><Select onValueChange={(value) => field.onChange(value === '_clear_' ? undefined : value)} value={field.value ?? undefined} disabled={isSiteCompletelyReadOnly || !isEditor}><FormControl><SelectTrigger><SelectValue placeholder="Select Rig Type"/></SelectTrigger></FormControl><SelectContent><SelectItem value="_clear_" onSelect={(e) => { e.preventDefault(); field.onChange(undefined); }}>-- Clear Selection --</SelectItem>{siteTypeOfRigOptions.map(o=><SelectItem key={o} value={o}>{o}</SelectItem>)}</SelectContent></Select><FormMessage /></FormItem>)}/> </div> )}
                                                    {purpose === 'TWC' && ( <div className="grid md:grid-cols-3 gap-6"><FormField control={form.control} name={`siteDetails.${index}.diameter`} render={({ field }) => (<FormItem><FormLabel>Diameter (mm){isDiameterRequired && <span className="text-destructive">*</span>}</FormLabel><Select onValueChange={(value) => field.onChange(value === '_clear_' ? undefined : value)} value={field.value ?? undefined} disabled={isSiteCompletelyReadOnly || !isEditor}><FormControl><SelectTrigger><SelectValue placeholder="Select Diameter"/></SelectTrigger></FormControl><SelectContent><SelectItem value="_clear_" onSelect={(e) => { e.preventDefault(); field.onChange(undefined); }}>-- Clear Selection --</SelectItem>{siteDiameterOptions.map(o=><SelectItem key={o} value={o}>{o}</SelectItem>)}</SelectContent></Select><FormMessage/></FormItem>)}/> <FormField control={form.control} name={`siteDetails.${index}.pilotDrillingDepth`} render={({ field }) => (<FormItem><FormLabel>Pilot Drilling Depth (m)</FormLabel><FormControl><Input {...field} value={field.value ?? ""} readOnly={isSiteCompletelyReadOnly || !isEditor} /></FormControl><FormMessage/></FormItem>)}/> <FormField control={form.control} name={`siteDetails.${index}.totalDepth`} render={({ field }) => (<FormItem><FormLabel>TD (m)</FormLabel><FormControl><Input type="text" inputMode="numeric" {...field} value={field.value ?? ""} readOnly={isSiteCompletelyReadOnly || !isEditor} /></FormControl><FormMessage/></FormItem>)}/> <FormField control={form.control} name={`siteDetails.${index}.surveyPlainPipe`} render={({ field }) => (<FormItem><FormLabel>Plain Pipe (m)</FormLabel><FormControl><Input {...field} value={field.value ?? ""} readOnly={isSiteCompletelyReadOnly || !isEditor} /></FormControl><FormMessage/></FormItem>)}/> <FormField control={form.control} name={`siteDetails.${index}.surveySlottedPipe`} render={({ field }) => (<FormItem><FormLabel>Slotted Pipe (m)</FormLabel><FormControl><Input {...field} value={field.value ?? ""} readOnly={isSiteCompletelyReadOnly || !isEditor} /></FormControl><FormMessage/></FormItem>)}/> <FormField control={form.control} name={`siteDetails.${index}.outerCasingPipe`} render={({ field }) => (<FormItem><FormLabel>MS Casing (m)</FormLabel><FormControl><Input {...field} value={field.value ?? ""} readOnly={isSiteCompletelyReadOnly || !isEditor} /></FormControl><FormMessage/></FormItem>)}/> <FormField control={form.control} name={`siteDetails.${index}.yieldDischarge`} render={({ field }) => (<FormItem><FormLabel>Discharge (LPH)</FormLabel><FormControl><Input {...field} value={field.value ?? ""} readOnly={isSiteCompletelyReadOnly || !isEditor} /></FormControl><FormMessage/></FormItem>)}/> <FormField control={form.control} name={`siteDetails.${index}.zoneDetails`} render={({ field }) => (<FormItem><FormLabel>Zone Details (m)</FormLabel><FormControl><Input {...field} value={field.value ?? ""} readOnly={isSiteCompletelyReadOnly || !isEditor} /></FormControl><FormMessage/></FormItem>)}/> <FormField control={form.control} name={`siteDetails.${index}.waterLevel`} render={({ field }) => (<FormItem><FormLabel>Water Level (m)</FormLabel><FormControl><Input {...field} value={field.value ?? ""} readOnly={isSiteCompletelyReadOnly || !isEditor} /></FormControl><FormMessage/></FormItem>)}/> <FormField control={form.control} name={`siteDetails.${index}.typeOfRig`} render={({ field }) => (<FormItem><FormLabel>Type of Rig</FormLabel><Select onValueChange={(value) => field.onChange(value === '_clear_' ? undefined : value)} value={field.value ?? undefined} disabled={isSiteCompletelyReadOnly || !isEditor}><FormControl><SelectTrigger><SelectValue placeholder="Select Rig Type"/></SelectTrigger></FormControl><SelectContent><SelectItem value="_clear_" onSelect={(e) => { e.preventDefault(); field.onChange(undefined); }}>-- Clear Selection --</SelectItem>{siteTypeOfRigOptions.map(o=><SelectItem key={o} value={o}>{o}</SelectItem>)}</SelectContent></Select><FormMessage /></FormItem>)}/> </div> )}
                                                    {purpose === 'FPW' && ( <div className="grid md:grid-cols-3 gap-6"> <FormField control={form.control} name={`siteDetails.${index}.diameter`} render={({ field }) => (<FormItem><FormLabel>Diameter (mm){isDiameterRequired && <span className="text-destructive">*</span>}</FormLabel><Select onValueChange={(value) => field.onChange(value === '_clear_' ? undefined : value)} value={field.value ?? undefined} disabled={isSiteCompletelyReadOnly || !isEditor}><FormControl><SelectTrigger><SelectValue placeholder="Select Diameter"/></SelectTrigger></FormControl><SelectContent><SelectItem value="_clear_" onSelect={(e) => { e.preventDefault(); field.onChange(undefined); }}>-- Clear Selection --</SelectItem>{siteDiameterOptions.map(o=><SelectItem key={o} value={o}>{o}</SelectItem>)}</SelectContent></Select><FormMessage/></FormItem>)}/> <FormField control={form.control} name={`siteDetails.${index}.totalDepth`} render={({ field }) => (<FormItem><FormLabel>TD (m)</FormLabel><FormControl><Input type="text" inputMode="numeric" {...field} value={field.value ?? ""} readOnly={isSiteCompletelyReadOnly || !isEditor} /></FormControl><FormMessage/></FormItem>)}/> <FormField control={form.control} name={`siteDetails.${index}.casingPipeUsed`} render={({ field }) => (<FormItem><FormLabel>Casing Pipe (m)</FormLabel><FormControl><Input {...field} value={field.value ?? ""} readOnly={isSiteCompletelyReadOnly || !isEditor} /></FormControl><FormMessage/></FormItem>)}/> <FormField control={form.control} name={`siteDetails.${index}.yieldDischarge`} render={({ field }) => (<FormItem><FormLabel>Discharge (LPH)</FormLabel><FormControl><Input {...field} value={field.value ?? ""} readOnly={isSiteCompletelyReadOnly || !isEditor} /></FormControl><FormMessage/></FormItem>)}/> <FormField control={form.control} name={`siteDetails.${index}.zoneDetails`} render={({ field }) => (<FormItem><FormLabel>Zone Details (m)</FormLabel><FormControl><Input {...field} value={field.value ?? ""} readOnly={isSiteCompletelyReadOnly || !isEditor} /></FormControl><FormMessage/></FormItem>)}/> <FormField control={form.control} name={`siteDetails.${index}.waterLevel`} render={({ field }) => (<FormItem><FormLabel>Water Level (m)</FormLabel><FormControl><Input {...field} value={field.value ?? ""} readOnly={isSiteCompletelyReadOnly || !isEditor} /></FormControl><FormMessage/></FormItem>)}/> <FormField control={form.control} name={`siteDetails.${index}.typeOfRig`} render={({ field }) => (<FormItem><FormLabel>Type of Rig</FormLabel><Select onValueChange={(value) => field.onChange(value === '_clear_' ? undefined : value)} value={field.value ?? undefined} disabled={isSiteCompletelyReadOnly || !isEditor}><FormControl><SelectTrigger><SelectValue placeholder="Select Rig Type"/></SelectTrigger></FormControl><SelectContent><SelectItem value="_clear_" onSelect={(e) => { e.preventDefault(); field.onChange(undefined); }}>-- Clear Selection --</SelectItem>{siteTypeOfRigOptions.map(o=><SelectItem key={o} value={o}>{o}</SelectItem>)}</SelectContent></Select><FormMessage /></FormItem>)}/> </div> )}
                                                    <FormField control={form.control} name={`siteDetails.${index}.drillingRemarks`} render={({ field }) => (<FormItem className="md:col-span-3"><FormLabel>Drilling Remarks</FormLabel><FormControl><Textarea {...field} value={field.value ?? ""} readOnly={isSiteCompletelyReadOnly || !isEditor} /></FormControl><FormMessage /></FormItem>)}/>
                                            ...
                                            {isDevPurpose && (
                                                <>
                                                    ...
                                                    <div className="grid md:grid-cols-3 gap-6">
                                                        ...
                                                        <FormField control={form.control} name={`siteDetails.${index}.totalDepth`} render={({ field }) => (<FormItem><FormLabel>TD (m)</FormLabel><FormControl><Input type="text" inputMode="numeric" {...field} value={field.value ?? ""} readOnly={isSiteCompletelyReadOnly || !isEditor} /></FormControl><FormMessage/></FormItem>)}/>
                                                        <FormField control={form.control} name={`siteDetails.${index}.yieldDischarge`} render={({ field }) => (<FormItem><FormLabel>Discharge (LPH)</FormLabel><FormControl><Input {...field} value={field.value ?? ""} readOnly={isSiteCompletelyReadOnly || !isEditor} /></FormControl><FormMessage/></FormItem>)}/>
                                                        <FormField control={form.control} name={`siteDetails.${index}.waterLevel`} render={({ field }) => (<FormItem><FormLabel>Water Level (m)</FormLabel><FormControl><Input {...field} value={field.value ?? ""} readOnly={isSiteCompletelyReadOnly || !isEditor} /></FormControl><FormMessage/></FormItem>)}/>
                                                        <FormField control={form.control} name={`siteDetails.${index}.drillingRemarks`} render={({ field }) => (<FormItem className="md:col-span-2"><FormLabel>Developing Remarks</FormLabel><FormControl><Textarea {...field} value={field.value ?? ""} readOnly={isSiteCompletelyReadOnly || !isEditor} /></FormControl><FormMessage/></FormItem>)}/>
                                                    </div>
                                                </>
                                            )}
                                            ...
                                            {isMWSSSchemePurpose && (
                                                <>
                                                    ...
                                                    <div className="grid md:grid-cols-3 gap-6">
                                                        <FormField control={form.control} name={`siteDetails.${index}.yieldDischarge`} render={({ field }) => (<FormItem><FormLabel>Well Discharge (LPH)</FormLabel><FormControl><Input type="text" inputMode="numeric" {...field} value={field.value ?? ""} readOnly={isSiteCompletelyReadOnly || !isEditor} /></FormControl><FormMessage/></FormItem>)}/>
                                                        <FormField control={form.control} name={`siteDetails.${index}.pumpingLineLength`} render={({ field }) => (<FormItem><FormLabel>Pumping Line Length (m)</FormLabel><FormControl><Input {...field} value={field.value ?? ""} readOnly={isSiteCompletelyReadOnly || !isEditor} /></FormControl><FormMessage/></FormItem>)}/>
                                                        <FormField control={form.control} name={`siteDetails.${index}.deliveryLineLength`} render={({ field }) => (<FormItem><FormLabel>Delivery Line Length (m)</FormLabel><FormControl><Input {...field} value={field.value ?? ""} readOnly={isSiteCompletelyReadOnly || !isEditor} /></FormControl><FormMessage/></FormItem>)}/>
                                                        <FormField control={form.control} name={`siteDetails.${index}.waterTankCapacity`} render={({ field }) => (<FormItem><FormLabel>Water Tank (L)</FormLabel><FormControl><Input type="text" inputMode="numeric" {...field} value={field.value ?? ""} readOnly={isSiteCompletelyReadOnly || !isEditor} /></FormControl><FormMessage/></FormItem>)}/>
                                                        <FormField control={form.control} name={`siteDetails.${index}.noOfTapConnections`} render={({ field }) => (<FormItem><FormLabel>Tap Connections</FormLabel><FormControl><Input type="text" inputMode="numeric" {...field} value={field.value ?? ""} readOnly={isSiteCompletelyReadOnly || !isEditor} /></FormControl><FormMessage/></FormItem>)}/>
                                                        <FormField control={form.control} name={`siteDetails.${index}.noOfBeneficiary`} render={({ field }) => (<FormItem><FormLabel>Beneficiaries</FormLabel><FormControl><Input {...field} value={field.value ?? ""} readOnly={isSiteCompletelyReadOnly || !isEditor} /></FormControl><FormMessage/></FormItem>)}/>
                                                        <FormField control={form.control} name={`siteDetails.${index}.pumpDetails`} render={({ field }) => (<FormItem className="md:col-span-3"><FormLabel>Pump Details</FormLabel><FormControl><Textarea {...field} value={field.value ?? ""} readOnly={isSiteCompletelyReadOnly || !isEditor} /></FormControl><FormMessage/></FormItem>)}/>
                                                        <FormField control={form.control} name={`siteDetails.${index}.workRemarks`} render={({ field }) => (<FormItem className="md:col-span-3"><FormLabel>Scheme Remarks</FormLabel><FormControl><Textarea {...field} value={field.value ?? ""} readOnly={isReadOnly || !siteIsEditable} /></FormControl><FormMessage /></FormItem>)}/>
                                                    </div>
                                                </>
                                            )}
                                            ...
                                            {isHPSPurpose && (
                                                <>
                                                    ...
                                                    <h4 className="text-md font-medium text-primary mb-2">Scheme Details</h4>
                                                    <div className="grid md:grid-cols-3 gap-6">
                                                        <FormField control={form.control} name={`siteDetails.${index}.totalDepth`} render={({ field }) => (<FormItem><FormLabel>Depth Erected (m)</FormLabel><FormControl><Input type="text" inputMode="numeric" {...field} value={field.value ?? ""} readOnly={isSiteCompletelyReadOnly || !isEditor} /></FormControl><FormMessage/></FormItem>)}/>
                                                        <FormField control={form.control} name={`siteDetails.${index}.waterLevel`} render={({ field }) => (<FormItem><FormLabel>Water Level (m)</FormLabel><FormControl><Input {...field} value={field.value ?? ""} readOnly={isSiteCompletelyReadOnly || !isEditor} /></FormControl><FormMessage/></FormItem>)}/>
                                                      <FormField control={form.control} name={`siteDetails.${index}.workRemarks`} render={({ field }) => (<FormItem><FormLabel>Scheme Remarks</FormLabel><FormControl><Textarea {...field} value={field.value ?? ""} readOnly={isReadOnly || !siteIsEditable} /></FormControl><FormMessage/></FormItem>)}/>
                                                    </div>
                                                </>
                                            )}
                                            ...
                                            {isARSPurpose && (
                                                <>
                                                    ...
                                                    <h4 className="text-md font-medium text-primary mb-2">Scheme Details</h4>
                                                    <div className="grid md:grid-cols-3 gap-6">
                                                        <FormField control={form.control} name={`siteDetails.${index}.arsNumberOfStructures`} render={({ field }) => (<FormItem><FormLabel>Number of Structures</FormLabel><FormControl><Input type="text" inputMode="numeric" {...field} value={field.value ?? ""} readOnly={isSiteCompletelyReadOnly || !isEditor} /></FormControl><FormMessage/></FormItem>)}/>
                                                        <FormField control={form.control} name={`siteDetails.${index}.arsStorageCapacity`} render={({ field }) => (<FormItem><FormLabel>Storage Capacity (m3)</FormLabel><FormControl><Input type="text" inputMode="numeric" {...field} value={field.value ?? ""} readOnly={isSiteCompletelyReadOnly || !isEditor} /></FormControl><FormMessage/></FormItem>)}/>
                                                        <FormField control={form.control} name={`siteDetails.${index}.arsNumberOfFillings`} render={({ field }) => (<FormItem><FormLabel>No. of Fillings</FormLabel><FormControl><Input type="text" inputMode="numeric" {...field} value={field.value ?? ""} readOnly={isSiteCompletelyReadOnly || !isEditor} /></FormControl><FormMessage/></FormItem>)}/>
                                                        <FormField control={form.control} name={`siteDetails.${index}.noOfBeneficiary`} render={({ field }) => (<FormItem><FormLabel>No. of Beneficiaries</FormLabel><FormControl><Input {...field} value={field.value ?? ""} readOnly={isSiteCompletelyReadOnly || !isEditor} /></FormControl><FormMessage/></FormItem>)}/>
                                                        <FormField control={form.control} name={`siteDetails.${index}.workRemarks`} render={({ field }) => (<FormItem className="md:col-span-2"><FormLabel>Remarks</FormLabel><FormControl><Textarea {...field} value={field.value ?? ""} readOnly={isReadOnly || !siteIsEditable} /></FormControl><FormMessage/></FormItem>)}/>
                                                    </div>
                                                </>
                                            )}
                                            ...
                                            <div className="grid md:grid-cols-3 gap-6">
                                                <FormField control={form.control} name={`siteDetails.${index}.dateOfCompletion`} render={({ field }) => ( <FormItem><FormLabel>Date of Completion{isCompletionDateRequired && <span className="text-destructive">*</span>}</FormLabel><FormControl><Input type="date" {...field} value={field.value ?? ""} readOnly={isSiteCompletelyReadOnly || !isEditor} /></FormControl><FormMessage/></FormItem> )}/>
                                                <FormField control={form.control} name={`siteDetails.${index}.totalExpenditure`} render={({ field }) => (<FormItem><FormLabel>Expenditure (₹)</FormLabel><FormControl><Input type="text" inputMode="numeric" {...field} value={field.value ?? ""} readOnly={isSiteCompletelyReadOnly || !isEditor} /></FormControl><FormMessage/></FormItem>)}/>
                                                <FormField
                                                    control={form.control}
