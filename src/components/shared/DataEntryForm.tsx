                                        ...
                                        <div className="border-t pt-6 space-y-6">
                                            ...
                                            {isWellPurpose && (
                                                <>
                                                    ...
                                                    {purpose === 'BWC' && ( <div className="grid md:grid-cols-3 gap-6"> <FormField control={form.control} name={`siteDetails.${index}.surveyRecommendedDiameter`} render={({ field }) => (<FormItem><FormLabel>Diameter (mm)</FormLabel><Select onValueChange={(value) => field.onChange(value === '_clear_' ? undefined : value)} value={field.value} disabled={!isSiteEditable || isSupervisor}><FormControl><SelectTrigger><SelectValue placeholder="Select Diameter" /></SelectTrigger></FormControl><SelectContent><SelectItem value="_clear_">-- Clear Selection --</SelectItem>{siteDiameterOptions.map(o => <SelectItem key={o} value={o}>{o}</SelectItem>)}</SelectContent></Select><FormMessage /></FormItem>)}/> <FormField control={form.control} name={`siteDetails.${index}.surveyRecommendedTD`} render={({ field }) => (<FormItem><FormLabel>TD (m)</FormLabel><FormControl><Input {...field} readOnly={!isSiteEditable || isSupervisor} /></FormControl><FormMessage/></FormItem>)}/> <FormField control={form.control} name={`siteDetails.${index}.surveyRecommendedOB`} render={({ field }) => (<FormItem><FormLabel>OB (m)</FormLabel><FormControl><Input {...field} readOnly={!isSiteEditable || isSupervisor} /></FormControl><FormMessage/></FormItem>)}/> <FormField control={form.control} name={`siteDetails.${index}.surveyRecommendedCasingPipe`} render={({ field }) => (<FormItem><FormLabel>Casing Pipe (m)</FormLabel><FormControl><Input {...field} readOnly={!isSiteEditable || isSupervisor} /></FormControl><FormMessage/></FormItem>)}/> <FormField control={form.control} name={`siteDetails.${index}.surveyLocation`} render={({ field }) => (<FormItem><FormLabel>Location</FormLabel><FormControl><Textarea {...field} readOnly={!isSiteEditable || isSupervisor} /></FormControl><FormMessage/></FormItem>)}/> <FormField control={form.control} name={`siteDetails.${index}.surveyRemarks`} render={({ field }) => (<FormItem><FormLabel>Survey Remarks</FormLabel><FormControl><Textarea {...field} readOnly={!isSiteEditable || isSupervisor} /></FormControl><FormMessage/></FormItem>)}/> </div> )}
                                                    {purpose === 'TWC' && ( <div className="grid md:grid-cols-3 gap-6"> <FormField control={form.control} name={`siteDetails.${index}.surveyRecommendedDiameter`} render={({ field }) => (<FormItem><FormLabel>Diameter (mm)</FormLabel><Select onValueChange={(value) => field.onChange(value === '_clear_' ? undefined : value)} value={field.value} disabled={!isSiteEditable || isSupervisor}><FormControl><SelectTrigger><SelectValue placeholder="Select Diameter" /></SelectTrigger></FormControl><SelectContent><SelectItem value="_clear_">-- Clear Selection --</SelectItem>{siteDiameterOptions.map(o => <SelectItem key={o} value={o}>{o}</SelectItem>)}</SelectContent></Select><FormMessage /></FormItem>)}/> <FormField control={form.control} name={`siteDetails.${index}.surveyRecommendedTD`} render={({ field }) => (<FormItem><FormLabel>TD (m)</FormLabel><FormControl><Input {...field} readOnly={!isSiteEditable || isSupervisor} /></FormControl><FormMessage/></FormItem>)}/> <FormField control={form.control} name={`siteDetails.${index}.surveyRecommendedPlainPipe`} render={({ field }) => (<FormItem><FormLabel>Plain Pipe (m)</FormLabel><FormControl><Input {...field} readOnly={!isSiteEditable || isSupervisor} /></FormControl><FormMessage/></FormItem>)}/> <FormField control={form.control} name={`siteDetails.${index}.surveyRecommendedSlottedPipe`} render={({ field }) => (<FormItem><FormLabel>Slotted Pipe (m)</FormLabel><FormControl><Input {...field} readOnly={!isSiteEditable || isSupervisor} /></FormControl><FormMessage/></FormItem>)}/> <FormField control={form.control} name={`siteDetails.${index}.surveyRecommendedMsCasingPipe`} render={({ field }) => (<FormItem><FormLabel>MS Casing (m)</FormLabel><FormControl><Input {...field} readOnly={!isSiteEditable || isSupervisor} /></FormControl><FormMessage/></FormItem>)}/> <FormField control={form.control} name={`siteDetails.${index}.surveyLocation`} render={({ field }) => (<FormItem><FormLabel>Location</FormLabel><FormControl><Textarea {...field} readOnly={!isSiteEditable || isSupervisor} /></FormControl><FormMessage/></FormItem>)}/> <FormField control={form.control} name={`siteDetails.${index}.surveyRemarks`} render={({ field }) => (<FormItem><FormLabel>Survey Remarks</FormLabel><FormControl><Textarea {...field} readOnly={!isSiteEditable || isSupervisor} /></FormControl><FormMessage/></FormItem>)}/> </div> )}
                                                    {purpose === 'FPW' && ( <div className="grid md:grid-cols-3 gap-6"> <FormField control={form.control} name={`siteDetails.${index}.surveyRecommendedDiameter`} render={({ field }) => (<FormItem><FormLabel>Diameter (mm)</FormLabel><Select onValueChange={(value) => field.onChange(value === '_clear_' ? undefined : value)} value={field.value} disabled={!isSiteEditable || isSupervisor}><FormControl><SelectTrigger><SelectValue placeholder="Select Diameter" /></SelectTrigger></FormControl><SelectContent><SelectItem value="_clear_">-- Clear Selection --</SelectItem>{siteDiameterOptions.map(o => <SelectItem key={o} value={o}>{o}</SelectItem>)}</SelectContent></Select><FormMessage /></FormItem>)}/> <FormField control={form.control} name={`siteDetails.${index}.surveyRecommendedTD`} render={({ field }) => (<FormItem><FormLabel>TD (m)</FormLabel><FormControl><Input {...field} readOnly={!isSiteEditable || isSupervisor} /></FormControl><FormMessage/></FormItem>)}/> <FormField control={form.control} name={`siteDetails.${index}.surveyRecommendedCasingPipe`} render={({ field }) => (<FormItem><FormLabel>Casing Pipe (m)</FormLabel><FormControl><Input {...field} readOnly={!isSiteEditable || isSupervisor} /></FormControl><FormMessage/></FormItem>)}/> <FormField control={form.control} name={`siteDetails.${index}.surveyLocation`} render={({ field }) => (<FormItem><FormLabel>Location</FormLabel><FormControl><Textarea {...field} readOnly={!isSiteEditable || isSupervisor} /></FormControl><FormMessage/></FormItem>)}/> <FormField control={form.control} name={`siteDetails.${index}.surveyRemarks`} render={({ field }) => (<FormItem><FormLabel>Survey Remarks</FormLabel><FormControl><Textarea {...field} readOnly={!isSiteEditable || isSupervisor} /></FormControl><FormMessage/></FormItem>)}/> </div> )}
