                                    ...
                                    <AccordionContent className="p-6 pt-0">
                                        ...
                                        <div className="border-t pt-6 space-y-6">
                                            ...
                                            <div className="grid md:grid-cols-2 gap-6">
                                                ...
                                                <FormField control={form.control} name={`siteDetails.${index}.longitude`} render={({ field }) => (<FormItem><FormLabel>Longitude</FormLabel><FormControl><Input type="text" inputMode="numeric" {...field} value={field.value ?? ""} readOnly={isReadOnly || !siteIsEditable} /></FormControl><FormMessage/></FormItem>)}/>
                                            </div>
                                            ...
                                            {isWellPurpose && (
                                                <>
                                                    ...
                                                    <FormField control={form.control} name={`siteDetails.${index}.drillingRemarks`} render={({ field }) => (<FormItem className="md:col-span-3"><FormLabel>Drilling Remarks</FormLabel><FormControl><Textarea {...field} value={field.value ?? ""} readOnly={isReadOnly || !siteIsEditable} /></FormControl><FormMessage /></FormItem>)}/>
                                            ...
                                            {isDevPurpose && (
                                                <>
                                                    ...
                                                    <div className="grid md:grid-cols-3 gap-6">
                                                        ...
                                                        <FormField control={form.control} name={`siteDetails.${index}.totalDepth`} render={({ field }) => (<FormItem><FormLabel>TD (m)</FormLabel><FormControl><Input type="text" inputMode="numeric" {...field} value={field.value ?? ""} readOnly={isReadOnly || !siteIsEditable} /></FormControl><FormMessage/></FormItem>)}/>
                                                        <FormField control={form.control} name={`siteDetails.${index}.yieldDischarge`} render={({ field }) => (<FormItem><FormLabel>Discharge (LPH)</FormLabel><FormControl><Input {...field} value={field.value ?? ""} readOnly={isReadOnly || !siteIsEditable} /></FormControl><FormMessage/></FormItem>)}/>
                                                        <FormField control={form.control} name={`siteDetails.${index}.waterLevel`} render={({ field }) => (<FormItem><FormLabel>Water Level (m)</FormLabel><FormControl><Input {...field} value={field.value ?? ""} readOnly={isReadOnly || !siteIsEditable} /></FormControl><FormMessage/></FormItem>)}/>
                                                        <FormField control={form.control} name={`siteDetails.${index}.drillingRemarks`} render={({ field }) => (<FormItem className="md:col-span-2"><FormLabel>Developing Remarks</FormLabel><FormControl><Textarea {...field} value={field.value ?? ""} readOnly={isReadOnly || !siteIsEditable} /></FormControl><FormMessage/></FormItem>)}/>
                                                    </div>
                                                </>
                                            )}
                                            ...
                                            {isMWSSSchemePurpose && (
                                                <>
                                                    ...
                                                    <div className="grid md:grid-cols-3 gap-6">
                                                        <FormField control={form.control} name={`siteDetails.${index}.yieldDischarge`} render={({ field }) => (<FormItem><FormLabel>Well Discharge (LPH)</FormLabel><FormControl><Input type="text" inputMode="numeric" {...field} value={field.value ?? ""} readOnly={isReadOnly || !siteIsEditable} /></FormControl><FormMessage/></FormItem>)}/>
                                                        <FormField control={form.control} name={`siteDetails.${index}.pumpingLineLength`} render={({ field }) => (<FormItem><FormLabel>Pumping Line Length (m)</FormLabel><FormControl><Input {...field} value={field.value ?? ""} readOnly={isReadOnly || !siteIsEditable} /></FormControl><FormMessage/></FormItem>)}/>
                                                        <FormField control={form.control} name={`siteDetails.${index}.deliveryLineLength`} render={({ field }) => (<FormItem><FormLabel>Delivery Line Length (m)</FormLabel><FormControl><Input {...field} value={field.value ?? ""} readOnly={isReadOnly || !siteIsEditable} /></FormControl><FormMessage/></FormItem>)}/>
                                                        <FormField control={form.control} name={`siteDetails.${index}.waterTankCapacity`} render={({ field }) => (<FormItem><FormLabel>Water Tank (L)</FormLabel><FormControl><Input type="text" inputMode="numeric" {...field} value={field.value ?? ""} readOnly={isReadOnly || !siteIsEditable} /></FormControl><FormMessage/></FormItem>)}/>
                                                        <FormField control={form.control} name={`siteDetails.${index}.noOfTapConnections`} render={({ field }) => (<FormItem><FormLabel>Tap Connections</FormLabel><FormControl><Input type="text" inputMode="numeric" {...field} value={field.value ?? ""} readOnly={isReadOnly || !siteIsEditable} /></FormControl><FormMessage/></FormItem>)}/>
                                                        <FormField control={form.control} name={`siteDetails.${index}.noOfBeneficiary`} render={({ field }) => (<FormItem><FormLabel>Beneficiaries</FormLabel><FormControl><Input {...field} value={field.value ?? ""} readOnly={isReadOnly || !siteIsEditable} /></FormControl><FormMessage/></FormItem>)}/>
                                                        <FormField control={form.control} name={`siteDetails.${index}.pumpDetails`} render={({ field }) => (<FormItem className="md:col-span-3"><FormLabel>Pump Details</FormLabel><FormControl><Textarea {...field} value={field.value ?? ""} readOnly={isReadOnly || !siteIsEditable} /></FormControl><FormMessage/></FormItem>)}/>
                                            ...
                                            {isHPSPurpose && (
                                                <>
                                                    ...
                                                    <h4 className="text-md font-medium text-primary mb-2">Scheme Details</h4>
                                                    <div className="grid md:grid-cols-3 gap-6">
                                                        <FormField control={form.control} name={`siteDetails.${index}.totalDepth`} render={({ field }) => (<FormItem><FormLabel>Depth Erected (m)</FormLabel><FormControl><Input type="text" inputMode="numeric" {...field} value={field.value ?? ""} readOnly={isReadOnly || !siteIsEditable} /></FormControl><FormMessage/></FormItem>)}/>
                                                        <FormField control={form.control} name={`siteDetails.${index}.waterLevel`} render={({ field }) => (<FormItem><FormLabel>Water Level (m)</FormLabel><FormControl><Input {...field} value={field.value ?? ""} readOnly={isReadOnly || !siteIsEditable} /></FormControl><FormMessage/></FormItem>)}/>
                                            ...
                                            {isARSPurpose && (
                                                <>
                                                    ...
                                                    <h4 className="text-md font-medium text-primary mb-2">Scheme Details</h4>
                                                    <div className="grid md:grid-cols-3 gap-6">
                                                        <FormField control={form.control} name={`siteDetails.${index}.arsNumberOfStructures`} render={({ field }) => (<FormItem><FormLabel>Number of Structures</FormLabel><FormControl><Input type="text" inputMode="numeric" {...field} value={field.value ?? ""} readOnly={isReadOnly || !siteIsEditable} /></FormControl><FormMessage/></FormItem>)}/>
                                                        <FormField control={form.control} name={`siteDetails.${index}.arsStorageCapacity`} render={({ field }) => (<FormItem><FormLabel>Storage Capacity (m3)</FormLabel><FormControl><Input type="text" inputMode="numeric" {...field} value={field.value ?? ""} readOnly={isReadOnly || !siteIsEditable} /></FormControl><FormMessage/></FormItem>)}/>
                                                        <FormField control={form.control} name={`siteDetails.${index}.arsNumberOfFillings`} render={({ field }) => (<FormItem><FormLabel>No. of Fillings</FormLabel><FormControl><Input type="text" inputMode="numeric" {...field} value={field.value ?? ""} readOnly={isReadOnly || !siteIsEditable} /></FormControl><FormMessage/></FormItem>)}/>
                                                        <FormField control={form.control} name={`siteDetails.${index}.noOfBeneficiary`} render={({ field }) => (<FormItem><FormLabel>No. of Beneficiaries</FormLabel><FormControl><Input {...field} value={field.value ?? ""} readOnly={isReadOnly || !siteIsEditable} /></FormControl><FormMessage/></FormItem>)}/>
                        ...
                        <Accordion type="multiple" className="w-full space-y-2">
                            {paymentFields.map((item, index) => {
                                ...
                                <AccordionItem value={`payment-${index}`} key={item.id} className="border bg-card rounded-lg shadow-sm">
                                    ...
                                    <div className="border-t pt-6 space-y-6">
                                        <div className="grid md:grid-cols-3 gap-6">
                                        <FormField control={form.control} name={`paymentDetails.${index}.dateOfPayment`} render={({ field }) => ( <FormItem><FormLabel>Date{hasAnyAmount && <span className="text-destructive">*</span>}</FormLabel><FormControl><Input placeholder="dd/mm/yyyy" {...field} value={field.value ?? ""} readOnly={isReadOnly || !isEditor} /></FormControl><FormMessage /></FormItem> )}/>
