                                            ...
                                            {isMWSSSchemePurpose && (
                                                <>
                                                    ...
                                                    <div className="grid md:grid-cols-3 gap-6">
                                                        ...
                                                        <FormField control={form.control} name={`siteDetails.${index}.pumpingLineLength`} render={({ field }) => (<FormItem><FormLabel>Pumping Line Length (m)</FormLabel><FormControl><Input {...field} readOnly={!isSiteEditable} /></FormControl><FormMessage/></FormItem>)}/>
                                                        <FormField control={form.control} name={`siteDetails.${index}.deliveryLineLength`} render={({ field }) => (<FormItem><FormLabel>Delivery Line Length (m)</FormLabel><FormControl><Input {...field} readOnly={!isSiteEditable} /></FormControl><FormMessage/></FormItem>)}/>
                                                        ...
                                                        <FormField control={form.control} name={`siteDetails.${index}.pumpDetails`} render={({ field }) => (<FormItem className="md:col-span-3"><FormLabel>Pump Details</FormLabel><FormControl><Textarea {...field} readOnly={!isSiteEditable} /></FormControl><FormMessage/></FormItem>)}/>
