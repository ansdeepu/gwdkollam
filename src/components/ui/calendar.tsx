...
function Calendar({
  ...
  const defaultFromYear = fromDateProp && isValid(fromDateProp) ? fromDateProp.getFullYear() : 2010;
  const defaultToYear = toDateProp && isValid(toDateProp) ? toDateProp.getFullYear() : 2050;
