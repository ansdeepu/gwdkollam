...
export default function ReportsPage() {
  ...
  const applyFilters = useCallback(() => {
    ...
    if (reportType === "pendingDashboardTasks") {
      ...
      if (statusFilter !== "all") currentEntries = currentEntries.filter(entry => entry.fileStatus === statusFilter);
  ...
  useEffect(() => {
    ...
    if (reportTypeFromQuery === "pendingDashboardTasks") {
      ...
      setStatusFilter(
        statusFromQuery && fileStatusOptions.includes(statusFromQuery as any)
          ? statusFromQuery
          : "all"
      );
