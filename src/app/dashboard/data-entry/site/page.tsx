      ...
      <form onSubmit={handleSubmit(onSubmit, onInvalid)} className="space-y-6">
        ...
        <Card>
            <CardHeader className="flex flex-row justify-between items-start">
                ...
                {isEditor && !isFormDisabled && <Button type="button" onClick={() => router.push('/dashboard/data-entry/site')} disabled={isSupervisor || isViewer}><PlusCircle className="h-4 w-4 mr-2" />Add Site</Button>}
            </CardHeader>
            <CardContent>
