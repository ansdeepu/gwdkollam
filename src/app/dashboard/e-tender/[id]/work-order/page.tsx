...
export default function WorkOrderPrintPage() {
    ...
    const supervisorListText = supervisors.length > 0 
        ? supervisors.map(s => `${s.nameMalayalam || s.name}, ${s.designationMalayalam || s.designation}<span class="text-lg">${s.phoneNo ? ` (ഫോൺ നമ്പർ: ${s.phoneNo})` : ''}</span>`).join(', ') 
        : '____________________';

    const mainParagraph = `മേൽ സൂചന പ്രകാരം ${tender.nameOfWorkMalayalam || tender.nameOfWork} നടപ്പിലാക്കുന്നതിന് വേണ്ടി താങ്കൾ സമർപ്പിച്ചിട്ടുള്ള ടെണ്ടർ അംഗീകരിച്ചു. ടെണ്ടർ ഷെഡ്യൂൾ പ്രവൃത്തികൾ ഏറ്റെടുത്ത് നിശ്ചിത സമയപരിധിയായ <span class="text-lg">${tender.periodOfCompletion || '___'}</span> ദിവസത്തിനുള്ളിൽ ഈ ഓഫീസിലെ <span class="text-lg">${supervisorListText}</span> എന്നിവരുടെ മേൽനോട്ടത്തിൽ വിജയകരമായി പൂർത്തിയാക്കി പൂർത്തീകരണ റിപ്പോർട്ടും വർക്ക് ബില്ലും ഓഫീസിൽ ഹാജരാക്കേണ്ടതാണ്.`;
          ...
          <div className="max-w-4xl mx-auto p-8 space-y-4 font-serif text-base">
              ...
              <div className="flex justify-between">
                  ...
                  <div className="text-right">
                      ...
                      <p className="text-lg">തീയതി: {formatDateSafe(tender.dateWorkOrder) || '__________'}</p>
                  </div>
              </div>
              ...
              <div className='pl-8 space-y-1 text-lg'>
              ...
              <div>
                ...
                <ol className="list-decimal list-outside ml-12 space-y-1 text-justify leading-normal">
                    ...
                    <li>വർക്ക് ഓർഡർ ലഭിച്ചതിന് <span class="text-lg">5</span> ദിവസത്തിനകം വർക്ക് തുടങ്ങിയിരിക്കേണ്ടതും, വർക്ക് ഓർഡറിൽ പറഞ്ഞിരിക്കുന്ന നിശ്ചിത ദിവസത്തിനകം വർക്ക് പൂർത്തീകരിക്കുകയും ചെയ്യേണ്ടതാണ്.</li>
                    ...
                    <li>കുടിവെള്ളപദ്ധതിയുടെ കെട്ടിട നമ്പർ, కറണ്ട് കണക്ഷൻ എന്നിവ എടുത്ത് സ്‌کീം പൂർത്തീകരിച്ച് ഓണർഷിപ്പ് സർട്ടിഫിക്കറ്റ് ലഭ്യമാക്കേണ്ടത് കോൺട್ರಾക്ടറുടെ ചുമതലയാണ്.</li>
              ...
              <div className="pt-8 text-right">
                  <p>വിശ്വസ്തതയോടെ</p>
                  <div className="h-12" />
                  <p className="font-semibold">ജില്ലా ఆഫീസർ</p>
              </div>
